...
A reliable default for any analytic paragraph (related work, discussion, threats to validity). This is not a rigid template, but if a paragraph feels weak, check whether one of the four elements is missing.
...
- **Missing explanation**: data dump with evidence but no interpretation. The reader has to do the analytic work themselves.
